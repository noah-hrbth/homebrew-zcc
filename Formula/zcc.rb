class Zcc < Formula
  ...
  on_arm do
    url "https://github.com/noah-hrbth/zed-claude-code/releases/download/v0.1.0/zcc-0.1.0-aarch64-apple-darwin.tar.gz"
    sha256 "02718d4230cc1527058f869f9a7363f8b840ddfa5cb3225dbda4fd54e1c6ae30"
  end

  on_intel do
    url "https://github.com/noah-hrbth/zed-claude-code/releases/download/v0.1.0/zcc-0.1.0-x86_64-apple-darwin.tar.gz"
